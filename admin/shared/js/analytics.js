...
function renderAnalytics(){
  ...
  const earnings=valid.filter(o=>o.created_by_manager_id).reduce((s,o)=>s+earningFor(o, role==='manager' ? ANALYTICS_PROFILE?.commission_percent : profilePct(o.created_by_manager_id)),0);
